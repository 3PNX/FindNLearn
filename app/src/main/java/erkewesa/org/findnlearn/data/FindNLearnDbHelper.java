...
public class FindNLearnDbHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME="findnLearnUsers.db";

    private static final String TEXT_TYPE=" TEXT";
    private static final String NUMVER_TYPE="INTEGER";
    private static final String COMMA_SEP=",";

    private final String SQL_CREATE_USER_TABLE_ENTRIES=
            "CREATE TABLE " +StudiengangContract.StudiengangEntry.TABLE_NAME + " (" +
            StudiengangContract.StudiengangEntry._ID + " INTEGER PRIMARY KEY," +
            StudiengangContract.StudiengangEntry.COLUMN_RANDOMKEY + TEXT_TYPE + COMMA_SEP +
            StudiengangContract.StudiengangEntry.COLUMN_USERNAME + TEXT_TYPE +
            " )";
